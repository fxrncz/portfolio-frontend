...
function HeroText({ playIntro = false, holdForIntro = false, onIntroComplete }) {
    ...
    const textColorRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])("rgb(0, 0, 0)");
    ...
    const [shaderReady, setShaderReady] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const redrawRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
                    ...
                    const drawText = {
                        "HeroText.useEffect.drawText": (r, d)=>{
                            ...
                            if (charSpans.length >= text.length) {
                                charSpans.forEach({
                                    "HeroText.useEffect.drawText": (span, idx)=>{
...
_s(HeroText, "UBCwNNpkyOfEEG+ZX0fMQ1owV2I=");
_c = HeroText;
var _c;
...
function AboutPageClient() {
    ...
    const handleHeroIntroComplete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AboutPageClient.useCallback[handleHeroIntroComplete]": ()=>{
...
_s(AboutPageClient, "WzsWYngpDOTmBVhLpJLPFq8p3Kg=");
_c = AboutPageClient;
var _c;
...
//# sourceMappingURL=app_about_15aa2372._.js.map